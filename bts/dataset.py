...
class TumorDataset(Dataset):
    ...
    def __init__(self, root_dir, transform=True, DEBUG=False):
        ...
        self.transform = {"hflip": TF.hflip, "vflip": TF.vflip, "rotate": TF.rotate}
    ...
    def _random_transform(self, image, mask):
        ...
        """
        # Only ever called from __getitem__ behind an `if self.transform:` guard,
        # but that guard doesn't narrow the type across the method boundary.
